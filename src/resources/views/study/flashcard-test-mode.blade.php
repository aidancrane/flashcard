    ...
    <div class="card">
        <div class="card-body user-generated-no-overflow" style="user-select:none;">
            ...
            <div class="pt-2">
                ...
                <div class="progress">
                    <div class="progress-bar bg-success" id="progress_bar_success" role="progressbar" style="width: 0%"></div>
                    <div class="progress-bar bg-danger" id="progress_bar_fail" role="progressbar" style="width: 0%"></div>
...
@push('scripts')
@vite(['resources/js/study-mode-viewer.js', 'resources/js/test-mode-viewer.js'])
